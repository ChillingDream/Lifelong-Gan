...
def Discriminator(input_shape):
    I=Input(input_shape)
    D=Conv2d(64,(4,4),(2,2),padding='SAME',act=lrelu,name='D_conv_1')(I)
    ...
    D=Conv2d(1,(4,4),(2,2),name='D_conv_7',b_init=tf.constant_initializer(0.0))(D)
...
def Generator(input_shape):
    ...
    G=BatchNorm2d(act=tf.nn.tanh)(DeConv2d(3,(4,4),(2,2),padding='SAME',name='G_deconv_8')(G))
...
def Encoder(input_shape,Z_dim):
    ...
    z=Elementwise(tf.add)([mu,Lambda(lambda x:tf.random.normal(shape=tf.shape(Z_dim))*tf.exp(x))(log_sigma)])
